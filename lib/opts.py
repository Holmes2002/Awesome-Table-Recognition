...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='./LORE_TSR/ckpt_wtw/model_best.pth',
                             help='path to pretrained model')
    self.parser.add_argument('--load_processor', default='./LORE_TSR/ckpt_wtw/processor_best.pth', 
