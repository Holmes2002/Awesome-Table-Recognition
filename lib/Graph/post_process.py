...
from lib.Graph.bbox_process import nms_inter_classes, bbox2adj, rect_max_iou
from lib.Graph.generate_html import area_to_html, format_html
    ...
    def post_processing(self, batch_result, **kwargs):
        ...
        for rid, result in enumerate(batch_result):
            ...
            if self.nms_inter:
                ...
                bboxes, labels = bboxes_results, [[0]] * len(bboxes_results[0])
